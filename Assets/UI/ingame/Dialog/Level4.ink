// Deskripsi suasana
* [Lihat kondisi buruh]
    Buruh tersebut terlihat kebingungan dan raut wajahnya tampak jengkel. #Narrative
    -> percakapan_utama
...
+ [Balas: "Lho, kok ditahan!?"]
    ...
    Buruh: "Gimana, ya, Nak. Kerja jadi buruh, gaji yang berkecukupan saja tidak cair. Apalagi sebagai ibu yang perlu ninggal anak di kampung, rasanya tidak ada keadilan sama sekali di sini." #NPC
...
=== simpati_pemain ===
Pemain: "Astaga... Ibu sudah rela-rela meninggalkan keluarga demi mereka, tapi malah tidak mendapatkan keadilan. Pasti membuat Ibu bingung dan merasa dikhianati." #Player
...
=== penutup ===
+ [Gratiskan makanan]
    Pemain: "Yaudah, Bu. Ini makanannya tidak perlu Ibu bayar. Semoga gajinya cepat cair, ya, Bu." #Player
